...
<div class="auth-wrap">
  ...
  <form method="post" autocomplete="on">
    ...
    <div class="form-group">
      ...
      <input type="email" id="email" name="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" autofocus required autocomplete="email">
    </div>
    <div class="form-group">
  ...
  <div class="auth-footer">
    Don't have an account? <a href="?module=register">Create one</a>
  </div>
</div>
</body>
</html>
